...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const response = await fetch("https://kodeo-backend-kc3t.onrender.com/api/career", {
        method: "POST",
        body: formData,
      });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      const response = await fetch("https://kodeo-backend-kc3t.onrender.com/api/contact", {
        method: "POST",
